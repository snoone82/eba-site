...
import { CTA_DARK_BG, ACCENT_RGB, ACCENT_GRAD } from "@/lib/constants";
      ...
      <div style={{
        ...
        {STATS.map(({ end, suffix, label }) => (
          <div key={label} style={{ textAlign: isMobile ? "center" : "left" }}>
            ...
            <div style={{ fontFamily: "'Roboto', sans-serif", fontSize: isMobile ? "12.5px" : "14px", color: "rgba(255,255,255,0.82)", marginTop: "10px", lineHeight: 1.4 }}>
              {label}
            </div>
          </div>
        ))}
