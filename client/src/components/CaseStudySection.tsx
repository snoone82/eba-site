          ...
          {CASE_STUDIES.map(cs => (
            <article key={`${cs.name}-${cs.company}`} style={{
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <div>
                  <p style={{ fontFamily: "'Roboto', sans-serif", fontWeight: 700, fontSize: "10.5px", letterSpacing: "0.1em", textTransform: "uppercase", color: `rgba(${NAVY_RGB},0.5)`, margin: "0 0 6px" }}>Before</p>
                  <p style={{ fontFamily: "'Roboto', sans-serif", fontSize: "14px", lineHeight: 1.6, color: `rgba(${NAVY_RGB},0.75)`, margin: 0 }}>{cs.before}</p>
                </div>
                <div>
                  <p style={{ fontFamily: "'Roboto', sans-serif", fontWeight: 700, fontSize: "10.5px", letterSpacing: "0.1em", textTransform: "uppercase", color: RUST, margin: "0 0 6px" }}>After</p>
                  <p style={{ fontFamily: "'Roboto', sans-serif", fontSize: "14px", lineHeight: 1.6, color: `rgba(${NAVY_RGB},0.75)`, margin: 0 }}>{cs.after}</p>
                </div>
              </div>
              <blockquote style={{
              ...
              <p style={{ fontFamily: "'Roboto', sans-serif", fontWeight: 600, fontSize: "13px", color: `rgba(${NAVY_RGB},0.72)`, margin: 0 }}>
                {cs.name} · {cs.company}
              </p>
            </article>
          ))}
