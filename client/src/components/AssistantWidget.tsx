...
const KB: { test: RegExp; answer: string }[] = [
  { test: /\b(price|pricing|cost|how much|fee|fees|expensive|afford)\b/i,
    answer: "Academy founding price is £999 — or £1,299 with the full 380-document library — locked for life (rises to £1,499 / £1,999 after the founding cohort closes). The AI tools are priced separately: RAMS £39/mo, COSHH £29/mo, both £49/mo (founder prices), O&M manuals £299 each compiled for you, and the Compliance Co-Pilot from £499 setup + £149/mo. Full detail's on the Pricing page." },
  { test: /\b(free|toolbox|talk generator|no cost|trial)\b/i,
    answer: "There's a free basic Toolbox Talk Generator — pick a task and get a site-ready toolbox talk with a sign-off sheet in about a minute; just drop your email on the AI Tools page. Academy members get the full version included with enrolment — the access link is provided once payment completes." },
  { test: /\b(o&m|om manual|manual compiler)\b/i,
    answer: "The O&M manual service is compiled for you: send your project data and a fully CDM-structured, client-ready manual comes back within 24 hours. It's £299 per manual. You review the output before it goes out." },
  { test: /\b(rams|method statement|risk assessment)\b/i,
    answer: "The RAMS Generator drafts method statements and risk assessments that are site-ready in minutes. It's £39 a month at the founder price (£49 with COSHH included)." },
  { test: /\b(coshh|substance|hazardous)\b/i,
    answer: "The COSHH Generator drafts substance assessments ready for you to review. It's £29 a month at the founder price (£49 with RAMS included)." },
  { test: /\b(co-?pilot|chatbot|assistant|hseq|knowledge)\b/i,
    answer: "The Compliance Co-Pilot is built for your business — trained on your company's HSEQ documentation, customised and hosted for you. Your team asks it questions and it answers instantly, in your firm's voice. Founder pricing is £499 setup plus £149 a month." },
  { test: /\b(ai|tools|software|automat)\b/i,
    answer: "We've built four AI tools for engineering contractors: the O&M Manual Compiler (£299 per manual, compiled for you), RAMS Generator (£39/mo), COSHH Generator (£29/mo — or £49/mo with RAMS) and the Compliance Co-Pilot (built for your business, from £499 setup + £149/mo). Trained on real contracting practice; you review every output. Not included with Academy membership. The AI Tools page has live demos." },
  { test: /\b(enrol|enroll|start|begin|when|join|sign ?up|cohort|waitlist|available)\b/i,
    answer: "Enrolment is open for the founding cohort — 30 places, and founding members lock in the lowest price for life (£999, or £1,299 with the document library). You can enrol now from the Academy or Pricing page." },
  ...
  { test: /\b(keyis|about|behind|real|experience|who are you|legit|trust)\b/i,
    answer: "EBA is built from 15 years of running a real M&E contracting business — through growth, restructuring and scale. Everything here comes from real operations, not theory." },
