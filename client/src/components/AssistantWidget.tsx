...
const KB: { test: RegExp; answer: string }[] = [
  { test: /\b(price|pricing|cost|how much|fee|fees|expensive|afford)\b/i,
    answer: "Academy founding-cohort pricing is announced soon — founding members lock in the founding price for life — it rises after the cohort closes. The four AI tools are priced separately (pay-per-use or subscription) — tool pricing is announced soon. Full detail's on the Pricing page." },
  ...
  { test: /\b(o&m|om manual|manual compiler)\b/i,
    answer: "The O&M Manual Compiler turns your project data into a fully CDM-structured O&M manual in minutes instead of days. It's pay-per-use — pricing announced soon. You review the output before it goes out." },
  { test: /\b(rams|method statement|risk assessment)\b/i,
    answer: "The RAMS Generator drafts method statements and risk assessments that are site-ready in minutes. It's a subscription — pricing announced soon." },
  ...
  { test: /\b(co-?pilot|chatbot|assistant|hseq|knowledge)\b/i,
    answer: "The Compliance Co-Pilot is trained on your company's HSEQ documentation — your team asks it questions and it answers instantly, in your firm's voice. Subscription pricing announced soon, or a managed white-label deployment for your whole business." },
