    ...
    <section style={{ position: "relative", overflow: "hidden", background: CTA_DARK_BG, padding: isMobile ? "48px 20px" : "64px 40px" }}>
      <div style={{
        ...
        <div>
          ...
          {sub && (
            <p style={{ fontFamily: "'Roboto', sans-serif", fontSize: isMobile ? "15px" : "17px", lineHeight: 1.6, color: IS_LIGHT ? "rgba(255,255,255,0.9)" : `rgba(${CREAM_RGB},0.8)`, margin: "12px 0 0", maxWidth: "560px" }}>
              {sub}
            </p>
          )}
        </div>
        <Link
          ...
          style={{
            ...
            textDecoration: "none", fontFamily: "'Roboto', sans-serif", fontWeight: 800,
